...
<fmt:formatNumber type="number" value="123456789.88" maxFractionDigits="1" /><br> <!-- maxFractionDigits 소수이하 첫째자리까지 출력 -->
<br>
...
<c:set var="now" value="<%=new java.util.Date() %>"/> <!-- 이렇게 자바코드와 $를 같이 쓰는 것은 좋지 않음. -->
<c:out value="${now }"/><br>
